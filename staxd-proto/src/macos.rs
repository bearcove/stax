//! macOS staxd protocol: the daemon owns kperf+kdebug and *streams*
//! raw `KdBuf` records to the client (xnu has no fd to hand over, so
//! the records themselves travel the wire).
