...
export const runControl_send_schemas: import("@bearcove/vox-core").ServiceSendSchemas = {
  schemas: new Map<bigint, import("@bearcove/vox-postcard").Schema>([
    ...
    [0x1e96b7f641715ed9n, { id: 0x1e96b7f641715ed9n, type_params: [], kind: { tag: 'struct', name: 'DiagnosticsSnapshot', fields: [{ name: 'server_started_at_unix_ns', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'active', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa938a91823178fd5n, args: [] }] }, required: true }] } }],
    [0x780feb414bb9e58fn, { id: 0x780feb414bb9e58fn, type_params: [], kind: { tag: 'struct', name: 'RunConfig', fields: [{ name: 'label', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'frequency_hz', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'dwarf_unwind', type_ref: { tag: 'concrete', type_id: 0x178367a87f66fb46n, args: [] }, required: true }] } }],
  ...
  methods: new Map<bigint, import("@bearcove/vox-core").MethodSendSchemas>([
    ...
    [0x7552fdb2e206709an, { argsRootRef: { tag: 'concrete', type_id: 0xbc5c33249a2dc720n, args: [] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0x1e96b7f641715ed9n, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x5db70a394660f3e6n, args: [] }] }] } }],
    [0xd1fa0143fbbb5525n, { argsRootRef: { tag: 'concrete', type_id: 0x915c6fb5b64f270bn, args: [{ tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, { tag: 'concrete', type_id: 0x780feb414bb9e58fn, args: [] }, { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0xde69b13dbe16811bn, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0xffd5a98ac5bd6a87n, args: [] }] }] } }],
